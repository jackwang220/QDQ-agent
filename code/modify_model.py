...
def add_qdq_after_nodes(model, node_names, fl_values):
    ...
    for node_name, fl_value in zip(node_names, fl_values):
        ...
        print(f"Added Q/DQ nodes after '{node_name}' with FL value {fl_value}")
...
def add_transpose_after_node(model, target_node_name, perm, transpose_node_name, output_name):
    ...
    print(f"add transpose after {target_node_name}, output name: {output_name}")
...
if __name__ == "__main__":
    ...
    # save modified model
    modified_model_path = "OD_model_with_bias.onnx"
